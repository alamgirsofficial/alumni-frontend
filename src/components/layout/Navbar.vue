...
<div v-else class="relative">
    ...
    <button
        ...
        class="flex items-center gap-1 text-blue-100
        hover:text-blue-400 transition-all duration-300
        text-xl md:text-base font-medium"
    >
        {{ item.name }}
    ...
    >
        ...
        <div
            v-if="isDropdownOpen"
            class="mt-3 md:mt-0 md:absolute md:top-full md:left-0
            md:w-52
        ...
        >
            ...
            >
                ...
                <!-- Arrow -->
                <span
                    class="mr-2 opacity-0 -translate-x-2
