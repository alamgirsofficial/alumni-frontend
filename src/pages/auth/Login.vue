...
<template>
    ...
    >
        ...
        <div
            class="relative z-10 grid w-full max-w-5xl overflow-hidden rounded-3xl border border-white/10 bg-white/[0.04] shadow-2xl shadow-black/40 backdrop-blur-2xl lg:grid-cols-2"
        >
            ...
            >
                ...
                <div class="relative">
                    ...
                    <p
                        class="mt-6 max-w-md text-sm leading-7 text-slate-400"
                    >
                        Connect with classmates, discover events,
                        share experiences and stay updated with
                        your alumni network.
                    </p>
                </div>
            ...
            <div
                class="p-6 sm:p-8 md:p-10 xl:p-12"
            >
                ...
                >
                    ...
                    >
                        ...
                        <span
                            class="text-[11px] font-medium text-blue-300"
                        >
                            Welcome back
                        </span>
                    </div>
                ...
                >
                    ...
                    >
                        ...
                        <button
                            type="button"
                            class="text-[10px] font-medium text-blue-400 transition hover:text-blue-300"
                    ...
                    <div class="mt-3 grid gap-2 sm:grid-cols-2">
                        ...
                        <button
                            type="button"
                            class="group rounded-xl border border-white/5 bg-white/[0.03] p-3 text-left transition hover:border-blue-400/20 hover:bg-white/5"
                        ...
                        <button
                            type="button"
                            class="group rounded-xl border border-white/5 bg-white/[0.03] p-3 text-left transition hover:border-cyan-400/20 hover:bg-white/5"
