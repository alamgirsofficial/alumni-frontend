...
const validateForm = () => {
    ...
    if (!imagePreview.value && !form.value.image) {
        notify({
            type: "error",
            text: "Please select a gallery image.",
        });
...
<template>
    <section class="mx-auto max-w-5xl space-y-6">
        ...
        >
            ...
            >
                <div
                    class="mb-6 border-b border-white/10 pb-5"
                >
                    <h2
            ...
            >
                ...
                >
                    ...
                    <div
                        class="flex min-h-64 flex-col items-center justify-center rounded-2xl border-2 border-dashed border-white/10 bg-slate-900/50 px-6 text-center transition hover:border-blue-500/30 hover:bg-blue-500/[0.02]"
                    >
                        <div
                        ...
                        <span
                            class="mt-4 rounded-lg bg-white/[0.05] px-3 py-2 text-xs text-slate-400"
                        >
                            Choose Image
                        </span>
                    </div>
