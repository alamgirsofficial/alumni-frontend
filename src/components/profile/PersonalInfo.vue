...
<template>
  <section class="
    ...
    description="Your basic personal and identity details" 
    icon="User" icon-class="bg-blue-500/10 text-blue-400" />
    ...
    <div class="mt-6 grid grid-cols-1 gap-3 sm:grid-cols-2">
      ...
      <div class="
          ...
          p-4
          transition-all duration-300
          hover:border-pink-400/10
          hover:bg-pink-400/[0.025]
        ">
        <div class="flex items-start gap-3">
      ...
      <div class="
          ...
          p-4
          transition-all duration-300
          hover:border-slate-400/10
          hover:bg-slate-400/[0.025]
        ">
        <div class="flex items-start gap-3">
